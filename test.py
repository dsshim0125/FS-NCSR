...
if __name__=="__main__":
    ...
    parser.add_argument('--lrtest_path', default='/media/deepest/DIV2K-te_8X', type=str)
    parser.add_argument('--conf_path', default='/home/dsshim/Pycharm/NCSR_NTIRE22/confs/8X.yml', type=str)
    parser.add_argument('--output_path', default="/media/deepest/NCSR_DF_test/", type=str)
    ...
    test_root = "/media/deepest/NCSR_test/"
    tmp_root = "/media/deepest/NCSR_tmp2/"
        ...
        if i in check:
            with torch.no_grad():
                ...
                for ii in range(n_sample):
                    ...
                    path_out_sr = tmp_root + f'{i:06d}_sample{ii:05d}.png'
